const translations = {
  ja: {
    ...
    heroTitle1: "バズった動画、",
    heroTitle2: "ぜんぶここに。",
    heroSub1: "みんなで見つけて、みんなで育てる",
    heroSub2: "動画ランキング",
    viewRanking: "ランキングを見る",
    submitVideoBtn: "動画を投稿する",
    howItWorks: "かんたん3ステップ",
    howItWorksSub: "バズ動画をみんなでシェアして、ランキングをつくろう",
    step1Title: "見つける",
    step1Desc: "バズっている動画のURLをコピー",
    step2Title: "投稿する",
    step2Desc: "BuzzClipにURLを貼るだけ カテゴリを選択",
    step3Title: "みんなで育てる",
    step3Desc: "いいねで動画がランキングUP",
    browseCategory: "カテゴリから探す",
    browseCategorySub: "気になるジャンルのバズ動画をチェック",
    ctaTitle: "今すぐバズ動画を探そう",
  ...
  en: {
    ...
    private: "Private",
    // Home
    heroTitle1: "Viral Videos,",
    heroTitle2: "All in One Place.",
    heroSub1: "Discover together, grow together",
    heroSub2: "Video Rankings",
    viewRanking: "View Rankings",
    submitVideoBtn: "Submit a Video",
    howItWorks: "How It Works",
    howItWorksSub: "Share buzz videos and build the ranking together",
    step1Title: "Find",
    step1Desc: "Copy the URL of a viral video",
    step2Title: "Submit",
    ...
    browseCategorySub: "Check out trending videos in your favorite genres",
    ctaTitle: "Find Viral Videos Now",
